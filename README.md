...
6. Optimised padding for strassen's. Instead of padding to the smallest power of 2, find an integer $m = \left \lceil{1/2^n}\right \rceil  $ smaller than the threshold, then multiply back.
